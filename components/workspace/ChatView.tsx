...
const ChatView = () => {
  ...
  const onGenerate=(input: string )=>{
     if (userDetail && userDetail?.tokens < 4000){
      toast.error("You don't have enough tokens, please upgrade your plan to continue chatting...")
      return;
    }
  ...
  return (
    <div className='relative h-[76vh] flex flex-col'>
      ...
      {/* <div className="flex gap-2 items-end">
        {userDetail&& <Image src={userDetail?.pic} height={30} width={30} onClick={toggleSidebar} alt="user" className="rounded-full cursor-pointer"/>} */}
