export const LOOKUP = {
  ...
  SIGNIN_HEADING: "Continue With Kinetic",
  SIGNIN_SUBHEADING:
    "To use Kinetic you must log into an existing account or create one.",
  SIGNIN_AGREEMENT_TEXT:
    "By using Kinetic, you agree to the collection of usage data for analytics.",
...
`,
  ...
  PRICING_OPTIONS: [
    ...
    },
    {
      ...
      tokens: "120K",
      value: 120000,
      desc: "Designed for professionals who need to use Kinetic a few times per week.",
      price: 9.99,
    },
    {
      name: "Pro",
